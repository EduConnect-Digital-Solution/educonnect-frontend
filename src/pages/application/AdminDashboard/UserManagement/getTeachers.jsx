...
const mockUsers = [
    ...
    { id: 2, name: 'Jane Smith', email: 'jane.smith@parent.com', role: 'Teacher', status: 'Active', lastLogin: '1 day ago' },
    { id: 3, name: 'Michael Brown', email: 'mbrown@school.com', role: 'Teacher', status: 'Active', lastLogin: '3 hours ago' },
    { id: 4, name: 'Sarah Johnson', email: 'sarah.j@parent.com', role: 'Teacher', status: 'Inactive', lastLogin: '2 weeks ago' },
    { id: 5, name: 'David Wilson', email: 'dwilson@school.com', role: 'Teacher', status: 'Active', lastLogin: '30 mins ago' }
];
                ...
                <main className="flex-1 p-6 flex flex-col">
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 flex flex-col h-full">
                        ...
                        <div className="p-6 flex flex-col md:flex-row justify-between items-center gap-4 border-b border-gray-100 flex-shrink-0">
                            <div>
                                <h2 className="text-xl font-bold text-gray-800">Teacher Management Table</h2>
                                <p className="text-sm text-gray-500 mt-1">
                                    Showing {startIndex + 1}-{Math.min(endIndex, filteredUsers.length)} of {filteredUsers.length} teachers
                                </p>
                            </div>
                        ...
                        <div className="relative w-full max-w-2xl rounded-2xl bg-white p-6 shadow-xl">
                            ...
                            <form className="space-y-5">
                                ...
                                <div className="grid grid-cols-2 gap-4">
                                    <Input label="First Name" defaultValue={viewTeacher.firstName} />
                                    <Input label="Last Name" defaultValue={viewTeacher.lastName} />
                                </div>

                                <Input label="Email" defaultValue={viewTeacher.email} />
                                <Input label="School ID" defaultValue={viewTeacher.schoolId} />

                                <Input label="Phone" defaultValue={viewTeacher.phone} />
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="mt-2 w-full px-3 py-2 text-sm border border-gray-200 rounded-lg focus:ring-2 focus:ring-blue-500"
                                        onKeyDown={(e) => {
                                            if (e.key === 'Enter') {
                                                e.preventDefault();
                                ...
                                <Input
                                    ...
                                    defaultValue={viewTeacher.qualifications}
                                />
                                ...
                                <Input
                                    ...
                                    type="number"
                                    defaultValue={viewTeacher.experience}
                                />
