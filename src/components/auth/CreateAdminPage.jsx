...
import {ArrowLeft, School, User, Mail, Lock, Phone, Building2, MapPin, EyeOff, Eye} from 'lucide-react';
import {NavLink} from "react-router-dom";
import {Images} from "../images.jsx";

export function CreateAdminPage({ onNavigate }) {
    ...
    const handleSubmit = () => {
        console.log('Admin account creation:', formData);
        onNavigate('verifySchool');
    };
                ...
                <div className="max-w-6xl w-full bg-white rounded-xl shadow-2xl overflow-hidden flex flex-col lg:flex-row">
                    ...
                    <div className="w-full lg:w-1/2 p-8 md:p-12 flex flex-col justify-center">
                        ...
                        <p className="text-center text-sm text-gray-600 mt-6">
                            Already registered?{' '}
                            <button
                                onClick={() => onNavigate('welcome')} // Added a placeholder onClick for clarity
